				...
				<ModalBody>
					<Form>
						<FormGroup>
							...
							<Input type="text" name="text" id="todoItem" placeholder="write todo" onChange={this.HandleOnChange} />
						</FormGroup>
					</Form>
				</ModalBody>
				<ModalFooter>
					<Button color="primary" onClick={this.createNewTodo} disabled={this.isDisabled()}>
						Do Something
					</Button>{' '}
